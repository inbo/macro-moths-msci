...
msci_draws_df_ellenberg <- as_tibble(exp(t(contrast_mat %*% t(draw_matrix))) - 1) %>%
...
contrast_mat <- rbind(
  ...
  matrix(cbind(create_contrast_matrix(3), 
             matrix(c(rep(1, 3), rep(0, 6)), ncol = 3), 
             contr.treatment(3),
             matrix(rep(0, 4 * 3), 3)), nrow = 3),
  matrix(cbind(create_contrast_matrix(3), 
             matrix(c(rep(0, 3), rep(1, 3), rep(0, 3)), ncol = 3), 
             matrix(rep(0, 2 * 3), 3),
             contr.treatment(3),
             matrix(rep(0, 2 * 3), 3)), nrow = 3),
  matrix(cbind(create_contrast_matrix(3), 
             matrix(c(rep(0, 6), rep(1, 3)), ncol = 3), 
             matrix(rep(0, 4 * 3), 3),
             contr.treatment(3)), nrow = 3)
)
