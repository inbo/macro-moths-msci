...
> not a good solution, NA for combinations of traits --> no suffix but importance of group_by?
...
for (i in seq_len(ncol(combinations))) {
  ...
  if (!(setequal(c("HabitatTemperature", "TempHum"), combo) ||
    ...
    combo_frame <- filtered_df %>%
      ...
      pivot_wider(
        id_cols = c(species_nl, n_grids, period, sum_per_period, rel_prop),
