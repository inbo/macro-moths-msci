...
We also write out the posterior draws in the log scale to create figures.
...
```{r}
write_csv(do.call(rbind.data.frame, draws_list_out),
          "output/msci_draw_list_log.csv")
```
