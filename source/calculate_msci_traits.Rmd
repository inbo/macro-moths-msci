...
```{r}
show_rhat(model_msci_list)
```

We check model fit based on posterior predicive checks were we compare the observed outcome to simulated datasets from the posterior predictive distribution.

```{r}
pp_check(fit_msci_Biotope_Phagy,
