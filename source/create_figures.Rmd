...
p_forewinglength <- msci_draw_list_log$ForewingLength %>%
  ggplot(aes(y = label)) +
    ...
    scale_x_continuous(breaks = index_breaks, labels = index_labels,
                       ...
                       sec.axis = sec_axis(~ exp(.),
                        breaks = index_breaks_rev(
                          msci_draw_list_log$ForewingLength$msci.draw
                          ),
                        labels = index_labels_rev(
                          msci_draw_list_log$ForewingLength$msci.draw
                          ),
...
p_distribution <- msci_draw_list_log$Distribution %>%
  ggplot(aes(y = label)) +
    ...
    scale_x_continuous(breaks = index_breaks, labels = index_labels,
                       ...
                       sec.axis = sec_axis(~ exp(.),
                        breaks = index_breaks_rev(
                          msci_draw_list_log$Distribution$msci.draw
                          ),
                        labels = index_labels_rev(
                          msci_draw_list_log$Distribution$msci.draw
                          ),
...
p_voltinism <- msci_draw_list_log$Voltinism %>%
  ggplot(aes(y = label)) +
    ...
    scale_x_continuous(breaks = index_breaks, labels = index_labels,
                       ...
                       sec.axis = sec_axis(~ exp(.),
                        breaks = index_breaks_rev(
                          msci_draw_list_log$Voltinism$msci.draw
                          ),
                        labels = index_labels_rev(
                          msci_draw_list_log$Voltinism$msci.draw
                          ),
...
p_migration <- msci_draw_list_log$Migration %>%
  ggplot(aes(y = label)) +
    ...
    scale_x_continuous(breaks = index_breaks, labels = index_labels,
                       ...
                       sec.axis = sec_axis(~ exp(.),
                        breaks = index_breaks_rev(
                          msci_draw_list_log$Migration$msci.draw
                          ),
                        labels = index_labels_rev(
                          msci_draw_list_log$Migration$msci.draw
                          ),
...
p_colourvariability <- msci_draw_list_log$colourVariability %>%
  ggplot(aes(y = label)) +
    ...
    scale_x_continuous(breaks = index_breaks, labels = index_labels,
                       ...
                       sec.axis = sec_axis(~ exp(.),
                        breaks = index_breaks_rev(
                          msci_draw_list_log$colourVariability$msci.draw
                          ),
                        labels = index_labels_rev(
                          msci_draw_list_log$colourVariability$msci.draw
                          ),
